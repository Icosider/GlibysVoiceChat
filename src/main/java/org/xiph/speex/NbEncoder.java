...
public class NbEncoder extends NbCodec implements Encoder {
    ...
    public int encode(Bits var1, float[] var2) {
        ...
        var11 = (float) Math.sqrt(1.0F + var11 / (float) super.frameSize);
        float var16;
        int var17;
        float var28;
        int var31;
        ...
        if (super.submodes[super.submodeID] == null) {
            ...
            var31 = (int) Math.floor(0.5D + 3.5D * Math.log(var11));
            if (var31 < 0) {
                var31 = 0;
            }
            ...
            for (var31 = 0; var31 < super.nbSubframes; ++var31) {
                ...
                var25 = (float) Math.sqrt(0.1F + var25 / (float) super.subframeSize);
                var25 /= var11;
            ...
            var16 = (float) (10.0D * Math.log((var28 + 1.0F) / (var30 + 1.0F)));
            var2[0] = super.frmBuf[super.frmIdx] + super.preemph * this.pre_mem2;
