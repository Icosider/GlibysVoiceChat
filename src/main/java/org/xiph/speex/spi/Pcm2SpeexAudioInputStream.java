...
public class Pcm2SpeexAudioInputStream extends FilteredAudioInputStream {
    ...
    public Pcm2SpeexAudioInputStream(int var1, int var2, InputStream var3, AudioFormat var4, long var5, int var7) {
        ...
        this.setVbr(var9 instanceof SpeexEncoding && ((SpeexEncoding) var9).isVBR());
    ...
    private void writeOggPageHeader(int var1, int var2) {
        ...
        AudioFileWriter.writeOggPageHeader(super.buf, super.count, var2, this.granulepos, this.streamSerialNumber, this.pageCount++, var1, new byte[var1]);
    ...
    private void writeOggPageChecksum() {
        ...
        AudioFileWriter.writeLong(super.buf, super.count + 6, this.granulepos);
    ...
    private void writeHeaderFrames() {
        ...
        AudioFileWriter.writeOggPageHeader(super.buf, super.count, 2, this.granulepos, this.streamSerialNumber, this.pageCount++, 1, new byte[]{(byte) 80});
        ...
        super.count = this.oggCount;
        AudioFileWriter.writeOggPageHeader(super.buf, super.count, 0, this.granulepos, this.streamSerialNumber, this.pageCount++, 1, new byte[]{(byte) (var1 + 8)});
        this.oggCount = super.count + 28;
