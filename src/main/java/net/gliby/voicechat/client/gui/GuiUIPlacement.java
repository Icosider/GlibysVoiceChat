...
public class GuiUIPlacement extends GuiScreen
{
    ...
    private static void drawRectLines(int par0, int par1, int par2, int par3, int par4)
    {
        ...
        wr.pos((double)par0, (double)par3, 0.0D).endVertex();
        wr.pos((double)par2, (double)par3, 0.0D).endVertex();
        wr.pos((double)par2, (double)par1, 0.0D).endVertex();
        wr.pos((double)par0, (double)par1, 0.0D).endVertex();
        tessellator.draw();
        GL11.glEnable(3553);
        GL11.glDisable(3042);
    }
